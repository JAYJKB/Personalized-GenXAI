...
# Streamlit UI
st.set_page_config(page_title="Personalized GenXAI", layout="wide")
st.title("Personalized GenXAI")
st.markdown(
    '<small>Welcome to the Personalized Explanations for Generative Artificial Intelligence prototype.<br>To get started, please choose the inference type and base model you would like to use for predictions using the selections in the left sidebar. Next, configure your settings in the "Profile" tab. Once your profile is set up, navigate to the "Home" tab to make your first prediction and receive a personalized explanation!</small>',
